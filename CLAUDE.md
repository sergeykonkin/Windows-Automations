...
- Hardcoded absolute paths (`D:\Automations`, `D:\Portable Programs\...`, `D:\Videos\CaptureCuts`, `C:\Program Files\HWiNFO64\...`) are intentional, not bugs — this tooling assumes a fixed D: drive layout that persists across reinstalls. Don't "fix" these into relative paths or parameters unless asked.
